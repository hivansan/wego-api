          ...
          AssetLoader.getCollection(db, body.slug, true)
            ...
            .then(({ collection }) => {
              ...
              Query.update(db, 'collections', collection.slug, { scoreRequests: (collection.scoreRequests ?? 0) + 1 }, true)
                .catch(e => console.log(`[score update collections]`, e));
              ...
              return countInDb([collection])
                ...
                .then(({ body }: any) => Stats.collection(collection.stats.count || body.results.length, body.results, collection.traits)
